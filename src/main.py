...
if(os.path.exists('../data/green_tripdata_2018-05_clean.csv')):
    green_taxi_df_clean = pd.read_csv('../data/green_tripdata_2018-05_clean.csv')
else:
    ...
    green_taxi_df_clean.to_csv('../data/green_tripdata_2018-05_clean.csv',index=False)
